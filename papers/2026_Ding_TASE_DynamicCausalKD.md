...
- Journal: **IEEE Transactions on Automation Science and Engineering**, 23, 5126–5144
...
论文目标是：
- capture fault mechanisms；
- diminish confounding side-effects embedded in data；
...
4. 结合 **causal prior** 对真实数据中的 confounding/correlation problem 进行处理；
5. 通过 **knowledge distillation** 向 Student 注入 dynamic + causal knowledge。

## 为什么比 Cui 2025 更接近我们

Cui 2025 的重点是 mechanism teacher + domain adaptation；
Ding 2026 已进一步明确讨论：
