...
- 期刊：**IEEE Transactions on Instrumentation and Measurement**, 72
...
\[
microscopic\ crack
\rightarrow mesoscopic\ spall
\rightarrow macroscopic\ defect
\]
...
- Teacher 应生成一个 \(P(E|Y,C)\) 的机制分布，而不是一条固定模板；
