...
- Journal: **Mechanical Systems and Signal Processing**, 257, 114639
...
所以 closed-set DT augmentation 在 open-world 场景会失效。
...
公开信息显示方法使用 bearing dynamic model 生成 known-fault virtual data，再做 virtual-real enhancement，并配合 open-set network 对 unknown class 进行拒识。
