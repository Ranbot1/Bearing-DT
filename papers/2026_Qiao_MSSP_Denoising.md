...
- Journal: **Mechanical Systems and Signal Processing**, 249, 114108
...
早期 bearing fault signals 很弱、噪声强，普通 denoising 容易把真正 fault impulses 一起去掉。
...
目的不是单纯分类，而是借助物理虚拟信号提供“干净 fault reference”来做 physical-virtual denoising。

## 对我们的启发

这与 mechanism-only teacher 的思想非常接近：

> virtual signal 可以充当“故障应该长什么样”的物理参考。
